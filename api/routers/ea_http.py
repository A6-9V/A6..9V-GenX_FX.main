...
Provides endpoints for EA registration, signal retrieval, heartbeat,
and trade reporting.
"""
...
async def account_status(request: MessageRequest):
    ...
    try:
        ...
        logger.info(
            f"Account status received from EA {ea_id} - "
            f"Balance: {status_data.get('balance')}, "
    ...
    try:
        ...
        if result_data.get("success"):
            logger.info(
                ...
                f"Signal: {result_data.get('signal_id')}, "
