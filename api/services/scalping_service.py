...
class ScalpingService:
    ...
    def _analyze_5m(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        """
        # ⚡ Bolt: Passing raw NumPy arrays to TA-Lib is ~1.6x faster than passing Pandas Series.
        # It also avoids redundant index alignment and validation overhead.
        ...
        # ⚡ Bolt: Direct array indexing is significantly faster than .iloc
        c_close = close[idx]
        c_ema20 = ema20[idx]
        c_ema50 = ema50[idx]
