...
def client():
    ...
    with patch("api.utils.ea_auth.settings") as mock_settings:
        mock_settings.EA_API_KEY = TEST_API_KEY
        mock_settings.EA_API_KEYS = None
...
class TestMultipleAPIKeys:
    ...
    def test_multiple_keys_config(self):
        ...
        with patch("api.utils.ea_auth.settings") as mock_settings:
            mock_settings.EA_API_KEY = None
            mock_settings.EA_API_KEYS = "key1,key2,key3"
...
class TestEndToEndWorkflow:
    ...
    def test_complete_ea_workflow(self, client, auth_headers):
        ...
        # Clear pending signals to ensure we get the one we send
        from api.routers.ea_http import pending_signals
