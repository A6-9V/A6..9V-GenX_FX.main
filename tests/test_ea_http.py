...
# Test API key for these tests
TEST_API_KEY = "test_key_http"
...
def setup_env():
    ...
    # No need to reload settings if we always use this key


if FASTAPI_AVAILABLE:
    client = TestClient(app)
    # Always include the API key in client headers for these tests
...
def clean_state():
    ...
    from api.routers.ea_http import clear_ea_state
